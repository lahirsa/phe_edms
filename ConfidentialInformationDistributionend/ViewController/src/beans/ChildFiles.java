...
public class ChildFiles {
    public ChildFiles(String fFileGUID,String did, String dDocName, String dFormat, String xDocNumber,
                      String dDocTitle, String xDocName, String xDocOwner, String xDocPurpose,String originalName) {
        super();
    ...
    public void setXDocPurpose(String xDocPurpose) {
        this.xDocPurpose = xDocPurpose;
    }

    public String getXDocPurpose() {
        return xDocPurpose;
    }
